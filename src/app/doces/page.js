...
export default function Doces(){
    ...
    const dataFindCategorie = data.filter(receita=> receita.categoria == 'Doce')
    ...
    return(
        ...
        <nav className="w-5/6 bg-colorTheme3 space-x-4 flex justify-evenly p-2 rounded-tl-xl rounded-tr-xl mt-4">
            ...
            <Link href={'/doces'} className="flex-auto text-colorTheme2 text-center p-2 text-lg hover:text-colorTheme2 duration-300">Doces</Link>
